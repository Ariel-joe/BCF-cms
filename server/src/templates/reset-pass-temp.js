...
<html dir="ltr" lang="en">
  ...
  <body
    style='background-color:rgb(243,244,246);padding-top:40px;padding-bottom:40px;font-family:ui-sans-serif, system-ui, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji"'>
    <!--$-->
    <div
        ...
        <tr style="width:100%">
          <td>
            <table
              ...
              <tbody>
                <tr>
                  <td>
                    <h1
                      style="font-size:24px;font-weight:700;color:rgb(17,24,39);margin:0px">
                      Reset Your Password
                    </h1>
                  </td>
                </tr>
            ...
            <table
              ...
              cellspacing="0"
              role="presentation"
              style="background-color:rgb(254,252,232);border-width:1px;border-color:rgb(254,240,138);border-radius:6px;padding:16px;margin-bottom:32px">
              <tbody>
                <tr>
                  <td>
                    <p
